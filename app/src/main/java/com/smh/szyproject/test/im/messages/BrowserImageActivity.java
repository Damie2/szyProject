...
import com.smh.szyproject.test.im.views.ImgBrowserViewPager;
import com.smh.szyproject.test.im.views.photoview.PhotoView;
...
public class BrowserImageActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_image_browser);
