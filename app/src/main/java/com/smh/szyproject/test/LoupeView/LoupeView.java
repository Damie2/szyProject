package com.smh.szyproject.test.LoupeView;
...
public class LoupeView extends AppCompatImageView {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getInt(R.styleable.LoupeView_louperadius, 100);
        SCALE = typedArray.getInt(R.styleable.LoupeView_loupescale, 3);
        typedArray.recycle();
    }
