package com.smh.szyproject.test.imTwo.activity;
...
import com.smh.szyproject.test.imTwo.util.ChatUiHelper;
import com.smh.szyproject.test.imTwo.util.FileUtils;
    ...
    protected void initContent() {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (ivAudio != null) {
                    if (isSend) {
                        ivAudio.setBackgroundResource(R.mipmap.test_im2_audio_animation_list_right_3);
                    } else {
                        ivAudio.setBackgroundResource(R.mipmap.test_im2_audio_animation_list_left_3);
                    }
                    ivAudio = null;
                    MediaManager.reset();
                } else {
                    ...
                    MediaManager.reset();
                    if (isSend) {
                        ivAudio.setBackgroundResource(R.drawable.test_im2_audio_animation_right_list);
                    } else {
                        ivAudio.setBackgroundResource(R.drawable.test_im2_audio_animation_left_list);
                    }
    ...
    private void initChatUi() {
        ...
        mRvChat.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                mIvEmo.setImageResource(R.mipmap.test_im2_ic_emoji);
                return false;
            }
        });
        //
