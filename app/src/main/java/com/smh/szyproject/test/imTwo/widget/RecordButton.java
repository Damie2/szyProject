package com.smh.szyproject.test.imTwo.widget;
...
public class RecordButton extends AppCompatButton {
    ...
    private void initDialogAndStartRecord() {
       ...
       // view = new ImageView(getContext());
         view = View.inflate(getContext(), R.layout.test_im2_dialog_record, null);
         mStateIV = (ImageView) view.findViewById(R.id.rc_audio_state_image);
         mStateTV = (TextView) view.findViewById(R.id.rc_audio_state_text);
         mStateIV.setImageDrawable(getResources().getDrawable(R.drawable.test_im2_anim_mic));
    ...
    private void finishRecord() {
        ...
        try {
            ...
            L.e("获取到的时长:"+mediaPlayer.getDuration()/1000);
        }catch (Exception e){
    ...
    private void startRecording() {
        ...
        mRecorder.setOutputFile(mFile);
         try {
            ...
            L.e("preparestart异常,重新开始录音:"+e.toString());
             e.printStackTrace();
            mRecorder.release();
            mRecorder = null ;
            startRecording();
