package com.smh.szyproject.test.payee.newPayee;
 ...
 * @Date 2022/3/2 16:20
 */
public class NewPayeeAdapter extends CommonAdapter<SortModel> implements ItemTouchStatus {
    ...
    public NewPayeeAdapter(List<SortModel> datas, Context context) {
        super(datas, context);
        this.mData = datas;
...
//        return R.layout.payee_item_my;
        return R.layout.payee_item_my1;
    }
