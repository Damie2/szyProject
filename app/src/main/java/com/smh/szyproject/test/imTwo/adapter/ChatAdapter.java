package com.smh.szyproject.test.imTwo.adapter;
...
import com.smh.szyproject.test.imTwo.bean.AudioMsgBody;
import com.smh.szyproject.test.imTwo.bean.FileMsgBody;
import com.smh.szyproject.test.imTwo.bean.ImageMsgBody;
import com.smh.szyproject.test.imTwo.bean.Message;
import com.smh.szyproject.test.imTwo.bean.MsgBody;
import com.smh.szyproject.test.imTwo.bean.MsgSendStatus;
import com.smh.szyproject.test.imTwo.bean.MsgType;
import com.smh.szyproject.test.imTwo.bean.TextMsgBody;
import com.smh.szyproject.test.imTwo.bean.VideoMsgBody;
import com.smh.szyproject.test.imTwo.util.GlideUtils;
...
public class ChatAdapter extends BaseQuickAdapter<Message, BaseViewHolder> {
    ...
    private static final int SEND_TEXT = R.layout.test_im2_item_text_send;
    private static final int RECEIVE_TEXT = R.layout.test_im2_item_text_receive;
    private static final int SEND_IMAGE = R.layout.test_im2_item_image_send;
    private static final int RECEIVE_IMAGE = R.layout.test_im2_item_image_receive;
    private static final int SEND_VIDEO = R.layout.test_im2_item_video_send;
    private static final int RECEIVE_VIDEO = R.layout.test_im2_item_video_receive;
    private static final int SEND_FILE = R.layout.test_im2_item_file_send;
    private static final int RECEIVE_FILE = R.layout.test_im2_item_file_receive;
   private static final int RECEIVE_AUDIO = R.layout.test_im2_item_audio_receive;
    private static final int SEND_AUDIO = R.layout.test_im2_item_audio_send;
    /*
